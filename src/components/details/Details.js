      ...
      <div className='details-container-area'>
        <div className='detail-container'>
          <div className='detail-title-container'>
            ...
            <h5 className='detail-title'>{`Contact ${
              user.name.split(' ')[0]
            }`}</h5>
          </div>
          <div className='detail-description'>{user.email}</div>
        ...
        <div className='detail-container'>
          ...
          <div className='detail-description'>{user.shipping_address}</div>
          <div className='detail-description'>{user.contact}</div>
        </div>
        <div className='detail-container'>
          <div className='detail-title-container'>
          ...
          <div className='detail-description'>{user.invoice_address}</div>
          <div className='detail-description'>{user.contact}</div>
        </div>
      </div>
